...
public class BuyTest {
    ...
    public void buyTest() {
        ...
        Assert.assertEquals(nameProduct, driver.findElement(By.xpath("//div[@class='cart_item'][1]//div[contains(@class,'item_name')]")).getText());
        Assert.assertEquals(costProduct, driver.findElement(By.xpath("//div[@class='cart_item'][1]//div[@class='inventory_item_price']")).getText());
